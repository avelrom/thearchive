...
- [Polyglot](https://github.com/untra/polyglot) - Multilingual and i18n support tool for Jekyll blogs
- [Typed.js](https://github.com/mattboldt/typed.js) - A JavaScript typing animation library
- [Video.js](https://github.com/videojs/video.js) - Open source HTML5 and Flash video player.
